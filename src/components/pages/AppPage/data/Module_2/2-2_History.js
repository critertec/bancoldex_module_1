    ...
    // 1 
        {
            ...
            feedback: "El hábito de ahorro es fundamental para el crecimiento de la empresa. Uno de los mayores errores que se comenten es aumentar los gastos a la vez que aumentan los ingresos. Si empieza a haber excedentes se sugiere ahorrarlos.",
            answer: {
                pages: [
                    {
                        desc: "Tienes toda la razón. Me merezco gastar algo en mí, pero no creo que necesite $ 500.000 mensuales adicionales para eso. Más bien, quisiera ir guardando esa plata.",
        ...
        // 1.1
            {
                ...
                feedback: "Si bien esconder el dinero en caja fuerte o en otro lugar es mejor que gastarlo, no estás protegiendo el dinero de diferentes situaciones como robos o perdida. Los servicios financieros te permiten tener mayor disponibilidad y seguridad de tus ahorros.",
                answer: {
                    pages: [
                        {
            ...
            // 1.1.1
                {
                    id: "1.1.1",
                    type: "buena",
                    desc: "Pregunta por un seguro más pequeño que cubra tu inventario máximo, y averigua si hay forma de pedir aumento del cupo si empiezas a crecer más rápido de lo pensado. ",
            ...
            // 1.1.2
                {
                    ...
                    feedback: "Es importante analizar las particularidades y necesidades de tu negocio. A veces, encontrarás servicios o productos que pueden no estar ajustados a tu estado actual. En este caso, el seguro ofrecido está cubriendo mucho más del inventario que tienes mensualmente. Un seguro que cubra menos, aún te cubrirá lo que necesitas y a menor costo.",
                    answer: {
                        pages: [
                            {
            ...
            // 1.1.3
                {
                    ...
                    answer: {
                        pages: [
                            {
                                desc: "Todo iba muy bien hasta el final del mes, cuando Gloria llegó al local y vio que se habían robado varias cajas de mercancía. Si hubiera estado asegurada, no habría tenido ningún problema. ¡No vuelve a pasar!"
                            }
                        ],
                        end: true
                    }
        ...
        // 1.3
            {
                id: "1.3",
                type: "mala",
                desc: "Abre una cuenta de ahorro programado con una cuota mensual de $ 600.000 COP. Después de un año ya tendrías 6 millones de pesos ahorrados. ",
                ...
                answer: {
                    pages: [
                        {
                            desc: "Después de la segunda cuota me di cuenta de que no podía mantener el pago de $ 500.000 COP mensuales, así que preferí entrar en una cuenta de ahorros para no quedar tan apretada. "
                        },
                        {
                            desc: [
    ...
    // 2
        {
            id: "2",
            type: "buena",
            desc: "Ahórrala en algún lugar seguro. Si mantienes el hábito de gastar menos de lo que recibes, estarás muy cerca de la independencia financiera. ",
        ...
        // 2.1
            {
                ...
                feedback: "Las cuentas de ahorro programado son una buena opción cuando puedes asegurar los excedentes mensuales y tienes un plan para ese dinero.",
                answer: {
                    pages: [
                        {
            ...
            // 2.1.1
                {
                    ...
                    answer: {
                        pages: [
                            {
                                desc: "Muchas gracias por tu consejo. Empecé a ahorrar $ 100.000 COP mensuales. Sé que no es mucho, pero algo es algo. Como siempre voy a consignar la cuota mensual, la gerente del banco me invitó a un café para que le contara un poco más del negocio. Quedó fascinada con mi entusiasmo, pero me dice que debo tener cuidado si mi empresa no está asegurada. "
                            },
                            {
                    ...
                    // 2.1.1.1
                        {
                            id: "2.1.1.1",
                            type: "buena",
                            desc: "¡Hazlo! Menos de $100.000 al mes y podrás estar tranquila sabiendo que tu mercancía está a salvo.",
                            feedback: "Los seguros deben ajustarse a tu estado actual. Define muy bien cuales son tus riesgos y entiende los costos en los que podrías incurrir si pasa una calamidad. Analiza tu flujo de caja y define cuál opción es la mejor.",
                            answer: {
                                pages: [
                                    {
            ...
            // 2.1.2
                {
                    id: "2.1.2",
                    type: "buena",
                    desc: "Ahorro de $ 300.000 COP",
                    feedback: "Si las cuotas son más altas de las que puedes pagar será contraproducente para tu flujo de caja operativa, o puedes tener penalizaciones en la tasa o en el retraso del desembolso.",
                    answer: {
                        pages: [
                            {
                                desc: "Muchas gracias por tu consejo. Empecé a ahorrar $ 300.000 COP y ya tengo un buen capital que me da tranquilidad. Sin embargo, la última vez la gerente del banco me contó que un cliente había perdido todo por no haber asegurado su empresa y no quería que me pasara lo mismo a mi. "
                            },
                            {
                                desc: "Me ofrecieron un seguro para PYMES que cubre Incendio, Robo o Inundación en mis locales. Tomarlo me cuesta $1.000.000 al año y puedo pagarlo mensualmente. Pero no estoy segura si quiero gastarme esa plata. Nunca me ha pasado nada. "
                            }
            ...
            // 2.1.3
                {
                    id: "2.1.3",
                    type: "mala",
                    desc: "Ahorro de $ 800.000 COP",
                    feedback: "Si las cuotas son más altas de las que puedes pagar será contraproducente para tu flujo de caja operativa, o puedes tener penalizaciones en la tasa o en el retraso del desembolso.",
                    answer: {
                        pages: [
                            {
                                desc: "Traté de hacerlo, pero hubo varios meses en los que no podía responder con la cuota mínima. Me tocó llamar al banco y cambiar las condiciones por unas más fáciles para mi, así que ahora tengo cuotas de $300.000. Por cierto, cuando hice el cambio me recomendaron asegurar la empresa en caso de cualquier calamidad."
                            },
                            {
                                desc: "Me ofrecieron un seguro para PYMES que cubre Incendio, Robo o Inundación en mis locales. Tomarlo me cuesta $1.000.000 al año y puedo pagarlo mensualmente. Pero no estoy segura si quiero gastarme esa plata. Nunca me ha pasado nada. "
                            }
